...
namespace Csdrx {
    ...
    class PipelineMeasureDelay {

        class Stage;

        public:
            PipelineMeasureDelay(Csdr::UntypedSource* source, bool deleteUnusedModules=false);
            ~PipelineMeasureDelay();
            ...
            PipelineMeasureDelay& operator|(Csdr::UntypedModule* module);
            PipelineMeasureDelay& operator|(Csdr::UntypedWriter* writer);
            void run();
        ...
        private:
            ...
            template <template<typename> typename T, typename U, typename P>
            bool untypedToTyped1complex(U* untyped, P pred);
